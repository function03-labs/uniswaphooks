...
>
  <img
    src="https://i.imgur.com/XjR8piI.png"
    width="60%"
...
<img
  width="758"
  alt="Screenshot 2023-10-03 at 4 44 41 PM"
  src="https://github.com/saucepoint/v4-template/assets/98790946/2307d06b-e8c5-4f65-bc1c-c0620b7cbad3"
/>
...
To support multiple trading pairs/pools, most state variables should be stored in a **mapping** -- keyed by the `PoolId` type. This is the case for the `Counter` hook, which stores the swap count for _each pool_
