...
export function AnnouncementBanner(props: AnnouncementBannerProps) {
  return (
    <div className="relative isolate flex items-center justify-center gap-x-6 overflow-hidden bg-secondary px-6 py-2.5 sm:px-3.5">
      <div
      ...
      <p className="flex-shrink flex-grow text-center text-sm leading-6 text-gray-900">
        <Link href={props.url}>
