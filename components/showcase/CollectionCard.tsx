      ...
      {componentData.category === "articles" && (
        <Link href={`/${componentData.id}`}>
          <div className="group relative block h-full bg-white before:absolute before:inset-0 hover:rounded-lg hover:border-2 hover:border-dashed hover:border-gray-900">
            <div className="animate-background rounded-md bg-gradient-to-r from-green-500 via-amber-800 to-lime-500 bg-[length:200%_200%] p-[2px] transition [animation-duration:_2s] group-hover:-translate-x-2 group-hover:-translate-y-2 md:block">
