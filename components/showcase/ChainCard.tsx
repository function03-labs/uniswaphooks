        ...
        <div className="max-w-md overflow-auto p-4 sm:p-6 lg:p-4">
          ...
          <div className="overflow-none mt-4 flex w-full justify-between">
            <div className="sm:text-md flex w-full flex-col items-center gap-2 text-sm">
              <div className="flex w-[280px]  items-center justify-between rounded-md border border-gray-800 bg-white px-4 py-3 align-bottom font-mono text-sm text-gray-800">
                <div className="flex w-[90%] max-w-full items-center gap-1 overflow-auto">
                  <span className="text-md font-semibold text-slate-600">
                    PoolManager
                  </span>
                ...
                <span className="ml-2 cursor-pointer  text-gray-800 duration-200 hover:text-gray-400 active:text-gray-600 lg:ml-0">
                  <Copy
                    onClick={() => {
